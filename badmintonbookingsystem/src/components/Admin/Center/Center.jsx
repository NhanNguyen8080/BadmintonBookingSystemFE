...
import { fetchAllCenters, updateCenterStatus } from "../../../services/centerService";
...
export default function Centers() {
    ...
    const toggleOpen = (id) => {
        setOpenCenterId((cur) => (cur === id ? null : id));
    };
    useEffect(() => {
            ...
            <div className="w-5/6 space-y-4 p-4">
              ...
              <div className="bg-zinc-100 rounded-lg overflow-hidden shadow-lg">
                <div className="grid grid-cols-8 gap-4 items-center justify-between p-2 bg-zinc-300">
                  <div className="text-center text-lg font-bold">Image</div>
                  <div className="text-center text-lg font-bold">Center Name</div>
                  <div className="text-center text-lg font-bold">Owner</div>
                  <div className="text-center text-lg font-bold">Location</div>
                  <div className="text-center text-lg font-bold">Opening Time</div>
                  <div className="text-center text-lg font-bold">Closing Time</div>
                ...
                {centers.map((center) => (
                  ...
                  >
                    <div className="text-center items-center justify-center">
                      <img
                        className="object-scale-down w-40 h-24"
                    ...
                    <div
                      ...
                      onClick={() => toggleOpen(center.id)}
                    >
                      <label className="text-gray-600">{center.name}</label>
                    </div>
                    <div className="text-center flex items-center justify-center">
                      {center.managerName}
                    </div>
                    <div className="text-center flex items-center justify-center">
                      <label className="text-gray-600">{center.location}</label>
                    </div>
                    <div className="text-center flex items-center justify-center">
                      <label className="text-gray-600">{center.operatingTime}</label>
                    </div>
                    <div className="text-center flex items-center justify-center">
                      {center.closingTime}
                    </div>
                    <div className="text-center flex items-center justify-center">
                      <button
                        onClick={() => handleChangeStatus(center.id)}
                    ...
                    <div className="space-x-4 flex items-center justify-center">
                      <button onClick={() => handleOpenUpdateModal(center)}>
                        <FontAwesomeIcon
                          icon={faPenToSquare}
                          style={{ color: "#B197FC" }}
                        />
